...
$lname_err = $fname_err = $username_err = $currency_err =  $email_err = $password_err = $cpassword_err = $phone_err = $country_err =  $plan_err =  "";

$fname = $lname = $username = $currency = $email = $password = $phone = $dob = $country = $accounttype = $btcwallet = $plan = "";
...
//   REGISTER 
  ...
  if (isset($_POST['register'])) {
      ...
      if (text_input($_POST['referral']) != "No referral") {
      	$refuser = text_input($_POST['referral']);
      	$chk = mysqli_query($link, "SELECT refcode FROM users WHERE refcode = '$refuser' ");
      ...
      } elseif (empty(text_input($_POST['cpassword']))) {
          $err .= "Confirm Password Field is empty";
      } elseif (text_input($_POST["password"]) != text_input($_POST["cpassword"])) {
      ...
      if (empty($err)) {
        ...
        $refcode = strtoupper(substr($fname, 0, 2)).$pin;
          
          $query = "INSERT INTO users (`email`, `fname`, `password`, `phone`, `currency`, `country`, `referral`, `refcode`, `occupation`) VALUES ('$email', '$fname', '$password', '$phone', '$currency', '$country', '$refuser', '$refcode', '$occupation') ";
          $save = mysqli_query($link, $query);

          if ($save) {
            $name = $fname;
            $subject = "Welcome to ".strtoupper($sitename);
            $body = "<h4>Hello ".$fname." </h4> <p>Your Registeration Was Successful</p> <p>Your login details are</p> <p>Email Address - <strong>".$email."</strong> </p>  <p>password - <strong>".$password."</strong> </p> <p>Website: <a href='".$siteurl."'>".$siteurl."</a> </p> <p>Email Address: <a href='".$sitemail."'>".$sitemail."</a> </p> ";
            sendMail($email, $name, $subject, $body);
            // mysqli_query($link, "UPDATE users SET ref_balance = ref_balance + $ref_bonus WHERE username = '$ref_user' ");
            $_SESSION['USER_LOGIN'] = $email;
            echo "<script>alert('Registration was successful, go to dashboard');window.location.href = '../user/' </script>";
          }else{
	...
	<div class="container-fluid">
		<div class="row">
			<div
				...
				<div class="col-sm-5 authfy-panel-left" style="background-color:#23272D">
					<div class="brand-col">
						<div class="headline">
							<!-- brand-logo start -->
							<div class="brand-logo">
								<center>
									<h2 style='font-size:24px;padding:10px;border-radius:10px;'> <img src='../logo.png'
							...
							<div class="row social-buttons">
								<div class="col-xs-12 col-sm-12 col-md-12">
									...
									<a href="../index.html" class="btn btn-block btn-facebook"
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									...
									<a href="#" data-panel=".panel-signup" href="#"
										...
										style="background-color:#fff;color:#000;font-weight:bolder">
										<center>
					...
					<div class="authfy-login">
						...
						<div class="authfy-panel panel-login text-center active">
							<div class="authfy-heading">
								...
								<p style="color:black">Don’t have an account? <a class="lnk-toggler"
										data-panel=".panel-signup" href="#" style="color:#274E82">Sign Up Free!</a></p>
							</div>
							<div class="row">
								<div class="col-xs-12 col-sm-12">
									<form name="loginForm" class="loginForm" method="POST">
										...
										<div class="form-group">
											<button name="login"
												style="background-color: #23272D;border:none;color:#fff;font-weight:bolder"
						...
						<div class="authfy-panel panel-signup text-center" style="overflow-x:auto">
							<div class="row">
								<div class="col-xs-12 col-sm-12">
									<div class="authfy-heading">
										<h3 class="auth-title" style="color:#274E82">Sign up for free!</h3>
									</div>
									<form name="signupForm" class="signupForm" method="POST">
										...
										<div class='form-group wrap-input'>
											<input type='text' readonly="" class='form-control' name='referral' value='<?php echo $ref_user ?>'>
										</div>
										...
										<div class="form-group">
											...
											<p class="term-policy text-muted small">I agree to the <a href="#"
													style="color:#274E82">privacy policy</a> and <a href="#"
													style="color:#274E82">terms of service</a>.</p>
										</div>
										<div class="form-group">
											<button name="register" style="background-color:#23272D;border:none"
												class="btn btn-lg btn-primary btn-block" type="submit">Sign Up
												Now</button>
										</div>
									</form>
									<a class="lnk-toggler" data-panel=".panel-login" href="#"
										style="color:#274E82;font-weight:bolder">Already have an Account ?</a>
