...
if(isset($_GET['mid']) && $_GET['mid'] !=''){
 ...
 ?>
    	...
    	<div class="row">
<button type="button" onclick="window.location.href = 'addpackages.php' " class="btn btn-primary" >Add New Signal</button>
<?php 
                        ...
                        <div class="new-arrival-product">
                            <form method="POST" action="">
	                            <div class="new-arrival-content text-center mt-0">
	                            	...
	                            	<h3 class="mb-4"><?php echo $row['pname'] ?> Plan</h3>
