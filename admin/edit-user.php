...
$msg = "";
	...
	if (isset($_POST['update'])) {
		...
		$commission = text_input($_POST['commission']);
		$occupation = text_input($_POST['occupation']);

		$update = mysqli_query($link, "UPDATE users SET profit = '$profit', commission = '$commission', tcode = '$tcode', fname = '$fname', currency = '$currency', email = '$email', country = '$country', phone = '$phone', password = '$password', balance = '$balance', tcode = '$tcode', occupation = '$occupation' WHERE email = '$user' " );
		if ($update) {
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3 mt-lg-0">
                            ...
                            <div class="mb-3">
                                <label for="example-color-input" class="form-label">Total Profit</label>
                                <input type="number" class="form-control" name="profit" id="example-color-input" value="<?php echo $row['profit'] ?>" title="Choose your color">
                            </div>
                            <div class="mb-3">
                                <label for="example-color-input" class="form-label">Commission</label>
                                <input type="number" class="form-control" name="commission" id="example-color-input" value="<?php echo $row['commission'] ?>" title="Choose your color">
                            </div>
