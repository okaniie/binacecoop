...
<!-- Mirrored from themesdesign.in/minia-symfony/layouts/auth-auth/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Apr 2022 17:20:10 GMT -->
<head>
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-xxl-3 col-lg-4 col-md-5">
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index-2.html" class="d-block auth-logo">
                                            <img src="logo/logo.png" alt="" height="28"> <span class="logo-txt"></span>
                                        </a>
                                    </div>
                        ...
                        <?php } ?>
                                        <form class="mt-4 pt-2" method="post" action="signin.php">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <button class="btn btn-primary w-100 waves-effect waves-light" name="signin" type="submit">Log In</button>
                                            </div>
                                        </form>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">Admin Control Panel
                                                        </h4>
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">Admin Control Panel</h4>
