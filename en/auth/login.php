                        ...
                        <div class="uk-grid uk-flex-center">
                            <div class="uk-width-3-5@m">
                                <div class="in-padding-horizontal@s">
                                  ...
                                  <!-- login form begin -->
                                   <form class="uk-grid uk-form" action="login.php" method="post"  >
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input class="uk-input uk-border-rounded" type="password" name="pwrd" id="pwd" size="30" placeholder="Enter Password *" required>
                                        </div>
                                        <div class="uk-margin-small uk-width-auto uk-text-small">
                                            <label><input class="uk-checkbox uk-border-rounded" type="checkbox"> Remember me</label>
                                        </div>
                                        <div class="uk-margin-small uk-width-expand uk-text-small">
                                            <label class="uk-align-right"><a class="uk-link-reset" href="reset.php">Forgot password?</a></label>
                                        </div>
